...
public class SwiftSignalRFlutterPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case CallMethod.connectToServer.rawValue:
      ...
      SignalR1Wrapper.instance.connectToServer(baseUrl: arguments["baseUrl"] as! String,
    ...
    case CallMethod.reconnect.rawValue:
      SignalR1Wrapper.instance.reconnect(result: result)
      break

    case CallMethod.stop.rawValue:
      SignalR1Wrapper.instance.stop(result: result)
      break

    case CallMethod.listenToHubMethod.rawValue:
      let methodName = call.arguments as! String
      SignalR1Wrapper.instance.listenToHubMethod(methodName: methodName, result: result)
      break

    case CallMethod.invokeServerMethod.rawValue:
      let arguments = call.arguments as! Dictionary<String, Any>
      SignalR1Wrapper.instance.invokeServerMethod(methodName: arguments["methodName"] as! String, arguments: arguments["arguments"] as? [Any], result: result)
      break
